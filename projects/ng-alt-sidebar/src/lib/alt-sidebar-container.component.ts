...
@Component({
  ...
  template: `
    <div
      *ngIf="showBackdrop"
      aria-hidden="true"
      class="ng-alt-sidebar__backdrop"
      [ngClass]="backdropClass"
      (click)="_onBackdropClicked()"
    ></div>

    <ng-content select="ng-alt-sidebar,[ng-alt-sidebar]"></ng-content>

    <div
      class="ng-alt-sidebar__content"
      [class.ng-alt-sidebar__content--animate]="animate"
      [ngClass]="contentClass"
      [ngStyle]="_getContentStyle()"
    >
      <ng-content select="[ng-alt-sidebar-content]"></ng-content>
    </div>
  `,
  styles: [
    `
      ...
      .ng-alt-sidebar__content--animate {
        -webkit-transition:
