...
@Component({
  ...
  template: `
    <aside
      ...
      class="ng-alt-sidebar ng-alt-sidebar--{{ opened ? 'opened' : 'closed' }} ng-alt-sidebar--{{
        position
      }} ng-alt-sidebar--{{ mode }}"
      [class.ng-alt-sidebar--docked]="_isDocked"
      [class.ng-alt-sidebar--inert]="_isInert"
      [class.ng-alt-sidebar--animate]="animate"
  ...
  styles: [
    `
      ...
      .ng-alt-sidebar--bottom {
        bottom: 0;
        left: 0;
        right: 0;
      }

      .ng-alt-sidebar--inert {
        pointer-events: none;
        touch-action: none;
        will-change: transform;
      }

      .ng-alt-sidebar--animate {
...
export class AltSidebarComponent implements AfterContentInit, OnInit, OnChanges, OnDestroy {
  ...
  get _isDocked(): boolean {
    return this.dock && this.dockedSize !== '0px' && !this.opened;
  }
